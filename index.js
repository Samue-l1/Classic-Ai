...
let botname = process.env.BOTNAME || '𝐁𝐋𝐀𝐂𝐊_𝐌𝐀𝐌𝐁𝐀-𝐀𝐈';

const owner = process.env.DEV || '263785189764'; // This will send a notification once the bot reconnects
const {
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, 𝐁𝐋𝐀𝐂𝐊 𝐌𝐀𝐌𝐁𝐀 has successfully connected to this server", "green"));
      console.log(color("Follow me on Instagram as @drex_mose", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `𝐁𝐋𝐀𝐂𝐊 𝐌𝐀𝐌𝐁𝐀 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .\n\n𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n\nHave fun with the bot😁` });
    }
